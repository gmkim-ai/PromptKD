...
BASE_PATH=${1-"."}
CKPT_NAME="llama-7B"
CKPT="${BASE_PATH}/checkpoints/llama/train/minillm_init/${CKPT_NAME}/"
TEACHER_CKPT_NAME="13B-sft"
TEACHER_CKPT="${BASE_PATH}/checkpoints/llama/train/sft/llama-13B/"
# MP_SIZE=4
# data
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/llama/train/promptkd/llama-7B-13B"
# seed
SEED=10
